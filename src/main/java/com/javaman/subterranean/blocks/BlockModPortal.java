...
public class BlockModPortal extends BlockBreakable
{
    ...
    {
        BlockModPortal.Size size = new BlockModPortal.Size(worldIn, p_176548_2_, EnumFacing.Axis.X);
        ...
        {
            BlockModPortal.Size size1 = new BlockModPortal.Size(worldIn, p_176548_2_, EnumFacing.Axis.Z);
    ...
    public void onNeighborBlockChange(World worldIn, BlockPos pos, IBlockState state, Block neighborBlock)
    {
        ...
        BlockModPortal.Size size;

        if (axis == EnumFacing.Axis.X)
        {
            size = new BlockModPortal.Size(worldIn, pos, EnumFacing.Axis.X);
        ...
        {
            size = new BlockModPortal.Size(worldIn, pos, EnumFacing.Axis.Z);
    ...
    public static class Size
        {
            ...
            protected int func_180120_a(BlockPos p_180120_1_, EnumFacing p_180120_2_)
            {
                ...
                for (i = 0; i < 22; ++i)
                {
                    ...
                    if (!this.func_150857_a(this.world.getBlockState(blockpos1).getBlock()) || this.world.getBlockState(blockpos1.down()).getBlock() != ModBlocks.SUBTERRANEAN_BLOCKS)
                    {
                        break;
                    }
                }
                ...
                return block == ModBlocks.SUBTERRANEAN_BLOCKS ? i : 0;
            }
            ...
            protected int func_150858_a()
            {
                ...
                for (this.field_150862_g = 0; this.field_150862_g < 21; ++this.field_150862_g)
                {
                    for (i = 0; i < this.field_150868_h; ++i)
                    {
                        ...
                        if (i == 0)
                        {
                            ...
                            if (block != ModBlocks.SUBTERRANEAN_BLOCKS)
                            {
                                break label56;
                            }
                        }
                ...
                for (i = 0; i < this.field_150868_h; ++i)
                {
                    if (this.world.getBlockState(this.field_150861_f.offset(this.field_150866_c, i).up(this.field_150862_g)).getBlock() != ModBlocks.SUBTERRANEAN_BLOCKS)
                    {
            ...
            public void func_150859_c()
            {
                for (int i = 0; i < this.field_150868_h; ++i)
                {
                    ...
                    {
                        this.world.setBlockState(blockpos.up(j), ModBlocks.PORTAL.getDefaultState().withProperty(BlockModPortal.AXIS, this.axis), 2);
                    }
                }
            }
        }
